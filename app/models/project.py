...
class Project(db.Model):
    ...
    time_tracking_enabled = db.Column(
        db.Boolean, nullable=True, default=True
    )  # Indique si le projet utilise la gestion de temps
    ...
    def add_credit(self, amount, note=None):
        ...
        log = CreditLog(project_id=self.id, amount=amount_minutes, note=note or f"Ajout de {amount}h de crédit")
        db.session.add(log)
