...
def main():
    ...
    if flask_env != "production":
        print(
            f"[{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}] Archivage automatique désactivé en environnement '{flask_env}'. Seul l'environnement 'production' permet l'archivage automatique."
        )
        return
