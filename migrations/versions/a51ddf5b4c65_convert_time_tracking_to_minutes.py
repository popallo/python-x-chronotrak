...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("project", schema=None) as batch_op:
        batch_op.alter_column("remaining_credit", existing_type=sa.Integer(), type_=sa.FLOAT(), existing_nullable=False)
        batch_op.alter_column("initial_credit", existing_type=sa.Integer(), type_=sa.FLOAT(), existing_nullable=False)
